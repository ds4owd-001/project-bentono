...
Data was collected from the \[FAO AQUASTAT Dissemination System\]([https://data.apps.fao.org/aquastat/?lang=en&share=f-8ef986ca-479a-4fde-a237-8f5b33572b11](#0){style="font-size: 11.4pt;"}) of the World Food and Agriculture Organisation, stored on an excel workbook, then impoted to R for cleaning and analysis to determine the exsiting renewable water resources in the region, water withdrawals, and access.
