...
Freshwater sustainability is the most crucial sustainable development challenge since it deals with most needed and finite resource on earth. Availability of freshwater resources plays an important role in determining the socio-economic development of a country or region. Table 1 gives the renewable water resources in the region by average and country. As of 2015, Kenya’s and South Sudan’s renewable water resources per capita were rated between 500 to 1,000 m^3^ (water scarcity). Tanzania and Uganda were rated between 1,700 to 2,500 m^3^ (vulnerable) the remaining countries in the east African region were rated between 1,000 to 1,700 m^3^ (water stressed) as depicted in Figure 1. By 2025, several countries in the Eastern
...
# Selecting the first four columns of the data set
...
new_column_names <- c("Country", "Precitation (mm/yr)", "Internal renewable water (million m3)", "Total renewable water (million m3)")
...
knitr::kable(water_access, "html") %>%
  kableExtra::add_header_above(c("Table 2: Access to safe drinking water in Eastern Africa (2015)" = 4)) %>%
